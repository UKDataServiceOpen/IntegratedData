...
![](pics/part_3.png){height=50% width=50% fig-alt="Section title with icons: accessing secure integrated dataset"}

## Searching for data

![](pics/search.png){height=90% width=90%  fig-alt="Screenshot from the new data search engine on the UK Data Service website"}
...
-   <span style="background-color:#00A9CE; color:white; padding:0.2em 0.4em; border-radius:4px;">Safe researcher training</span>
...
-   Accreditated researcher
-   Safe researcher training
-   <span style="background-color:#00A9CE; color:white; padding:0.2em 0.4em; border-radius:4px;">Secure access user agreement</span>
 -   Secure Lab account setup
